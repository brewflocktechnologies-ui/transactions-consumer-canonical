...
-- Username: SEND_TXN_OWNER, Password: Oracle123, Service: XEPDB1
-- Oracle schema is also user needs to create with password and oracle passwords are case sensitive


SELECT PRIVILEGE FROM DBA_SYS_PRIVS WHERE GRANTEE = 'SEND_TXN_OWNER'

-- Confirm tables exist after running init.sql
SELECT TABLE_NAME FROM DBA_TABLES WHERE OWNER = 'SEND_TXN_OWNER' ORDER BY TABLE_NAME
-- change password
ALTER USER SEND_TXN_OWNER IDENTIFIED BY Oracle123
GRANT CREATE SESSION      TO SEND_TXN_OWNER
GRANT CREATE TABLE        TO SEND_TXN_OWNER
GRANT UNLIMITED TABLESPACE TO SEND_TXN_OWNER
...
DROP TABLE SEND_TXN_OWNER.SEND_TRAN_ADDR_DTL CASCADE CONSTRAINTS;

DROP TABLE SEND_TXN_OWNER.SEND_RECIP_DTL CASCADE CONSTRAINTS;

DROP TABLE SEND_TXN_OWNER.SEND_TRAN_DTL CASCADE CONSTRAINTS;

-- =========================================================
-- DROP PARENT TABLE
-- =========================================================

DROP TABLE SEND_TXN_OWNER.SEND_TRANSACTIONS CASCADE CONSTRAINTS;

-- =========================================================
-- OPTIONAL : PURGE RECYCLE BIN
-- =========================================================
...
-- =========================================================
-- INDEXES : SEND_TRANSACTIONS
-- =========================================================

CREATE INDEX IDX_SEND_TXN_TRAN_INIT_ID
    ON SEND_TXN_OWNER.SEND_TRANSACTIONS (TRAN_INIT_ID);

CREATE INDEX IDX_SEND_TXN_REF_ID
    ON SEND_TXN_OWNER.SEND_TRANSACTIONS (REF_ID);

CREATE INDEX IDX_SEND_TXN_LOWER_REF_ID
    ON SEND_TXN_OWNER.SEND_TRANSACTIONS (LOWER(REF_ID));

CREATE INDEX IDX_SEND_TXN_TRAN_CRTE_DT
    ON SEND_TXN_OWNER.SEND_TRANSACTIONS (TRAN_CRTE_DT);

CREATE INDEX IDX_SEND_TXN_STATUS
    ON SEND_TXN_OWNER.SEND_TRANSACTIONS (CUR_STAT);

CREATE INDEX IDX_SEND_TXN_STATUSO
    ON SEND_TXN_OWNER.SEND_TRANSACTIONS (ORIG_STAT);

CREATE INDEX IDX_SEND_TXN_NETWORK_CD
    ON SEND_TXN_OWNER.SEND_TRANSACTIONS (NTWRK_CD);

CREATE INDEX IDX_SEND_TXN_USE_CASE
    ON SEND_TXN_OWNER.SEND_TRANSACTIONS (USE_CASE);

CREATE INDEX IDX_SEND_TXN_CUST_REF_NUM
    ON SEND_TXN_OWNER.SEND_TRANSACTIONS (CUST_REF_NUM);
...
CREATE TABLE SEND_TXN_OWNER.SEND_TRAN_DTL (
                                              ...
                                              CONSTRAINT SEND_TRAN_DTL_FK
                                                  FOREIGN KEY (TRAN_ID)
                                                      REFERENCES SEND_TXN_OWNER.SEND_TRANSACTIONS (TRAN_ID)
);

CREATE INDEX IDX_SEND_TRAN_DTL_TRAN_ID
    ON SEND_TXN_OWNER.SEND_TRAN_DTL (TRAN_ID);
...
CREATE INDEX IDX_SEND_RECIP_EMAIL
    ON SEND_TXN_OWNER.SEND_RECIP_DTL (SEND_EMAIL);

CREATE INDEX IDX_SEND_RECIP_PHN
    ON SEND_TXN_OWNER.SEND_RECIP_DTL (SEND_PHN);

CREATE INDEX IDX_SEND_RECIP_ACCT_URI
    ON SEND_TXN_OWNER.SEND_RECIP_DTL (SEND_ACCT_URI);
...
CREATE INDEX IDX_SEND_TRAN_ADDR_TRAN_ID
    ON SEND_TXN_OWNER.SEND_TRAN_ADDR_DTL (TRAN_ID);

CREATE INDEX IDX_SEND_TRAN_ADDR_TYPE
    ON SEND_TXN_OWNER.SEND_TRAN_ADDR_DTL (ADDR_TYPE);